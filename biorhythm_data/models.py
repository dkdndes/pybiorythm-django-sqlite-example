...
class BiorhythmCalculation(models.Model):
    ...
    pybiorythm_version = models.CharField(max_length=50, blank=True, help_text="PyBiorythm library version used")
...
class BiorhythmData(models.Model):
    ...
    calculation = models.ForeignKey(BiorhythmCalculation, on_delete=models.CASCADE, related_name='data_points', null=True, blank=True)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['is_physical_critical', 'is_emotional_critical', 'is_intellectual_critical']),
        ]
    ...
    def is_any_critical(self):
        ...
        return self.is_physical_critical or self.is_emotional_critical or self.is_intellectual_critical
